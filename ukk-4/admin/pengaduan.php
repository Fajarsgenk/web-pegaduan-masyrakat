        	...
        	<tbody>
				...
				while ($r = mysqli_fetch_assoc($query)) { ?>
        			<tr>
        				...
        				<td><a class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Details</a> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus?')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
								...
								if ($r['status'] == "proses") { ?>
        							<div class="col s12 m6">
        								<form method="POST">
        									...
        									<div class="col s12 input-field">
        										<input type="submit" name="tanggapi" value="Kirim" class="btn green">
        									</div>
        								</form>
        							</div>
        						<?php	}
