        	...
        	<tbody>
				...
				while ($r = mysqli_fetch_assoc($query)) { ?>
        			<tr>
        				...
        				<td><a class="btn teal modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus?')" class="btn red" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
