<table class="responsive-table" border="2" style="width: 100%;">
	<tr>
		<td>
			<h4 class="black-text hide-on-med-and-down">Tulis Laporan</h4>
		</td>
		<td>
			<h4 class="black-text hide-on-med-and-down">Daftar Laporan</h4>
		</td>
	</tr>
	<tr>
		<td style="padding: 20px;">
			<form method="POST" enctype="multipart/form-data">
				...
				<input type="submit" name="kirim" value="Kirim" class="btn green">
			</form>
		</td>
			...
			<table border="3" class="responsive-table striped highlight">
				...
				while ($r = mysqli_fetch_assoc($pengaduan)) { ?>
					<tr>
						...
						<td>
							<a class="btn blue modal-trigger" href="#tanggapan&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Details</a>
							<a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus?')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a>
						</td>
